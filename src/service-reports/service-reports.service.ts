    ...
    const stats = await this.serviceReportModel.aggregate([
      { $match: dateFilter },
      {
        $group: {
          ...
          avgMales: { $avg: '$numberOfMales' },
          avgFemales: { $avg: '$numberOfFemales' },
          avgChildren: { $avg: '$numberOfChildren' },
          latestMales: { $last: '$numberOfMales' },
          latestFemales: { $last: '$numberOfFemales' },
          latestChildren: { $last: '$numberOfChildren' },
        },
      },
    ]);
